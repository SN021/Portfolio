  ...
  return (
    ...
    >   
        <div className='container'>
            <div 
            className="bg-zinc-800/50 p-7 rounded-2xl md:p-12 backdrop-blur-lg reveal-up"
            >
                <p className="text-zinc-300 mb- mb:mb-8 mv:text-xl md:max-w-[60ch]">
                ...
                <div className="pt-6 flex flex-wrap items-center gap-4 md:gap-7">
                    {
                    ...
                    <img 
                        ...
                        height={30}
                        width={30}
                        className="ml-auto md:w-[40px] md:"
                    />
                </div>
            </div>
        </div>
