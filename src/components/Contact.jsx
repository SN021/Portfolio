...
const Contact = () => {
  return (
    ...
    id='contact'
    className="section">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch lg:gap-10">
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col ">
                <h2 className="headline-2 lg:max-w-[13ch] lg:text-left reveal-up">Contact me for collaboration</h2>
                ...
                <div className="flex items-center gap-2 mt-auto">
                    ...
                    <a
                     ...
                     href={href}
                     target='_blank'
                     className='reveal-up w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transistion-[background-color] duration-300 hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80'
                    >
                        {icon}
                    </a> 
                    ))}
            ...
            <form 
                action={import.meta.env.VITE_PUBLIC_GETFORM_URL}
                method='POST'
            ...
            >
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-4">
                    <div className="mb-4 flex flex-col">
                        ...
                        <input type="text" name="name" id="name" autoComplete='name' required className="text-field" placeholder='John Doe'/>
                    </div>

                    <div className="mb-4 flex flex-col">
                        <label htmlFor="email" className="label">E-Mail</label>
                        <input type="text" name="email" id="email" autoComplete='email' required className="text-field" placeholder='xKb0p@example.com'/>
                    </div>
                </div>
                ...
                <button 
                type="submit"
                className='btn btn-primary [&]:max-w-full w-full justify-center mt-8'
                >
                    Submit
                </button>
            </form>
